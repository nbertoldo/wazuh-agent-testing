...
if len(sys.argv) != 2:
    print("Usage: python3 get_groups_by_agent.py <agent_id>")
    sys.exit(1)
...
index_pattern = "wazuh-states-inventory-groups-vm-ubuntu2204-server*"
username = "admin"
password = "admin"
...
try:
    ...
    if response.status_code == 200:
        ...
        filename = f"inventory_groups_events_{agent_id}.json"
